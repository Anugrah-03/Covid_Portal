...
public class Kasargod extends JFrame {
	...
	private void displayKasargoddetails(Object [] row) {
		File file =new File("C:\\Users\\anugr\\Desktop\\kasargod.txt");
	...
	public Kasargod() {
		...
		JLabel lblNewLabel = new JLabel("Hospital In Kasargod");
