...
public class kannur1 extends JFrame {
	...
	private void displayKannurdetails(Object [] row) {
	File file =new File("C:\\Users\\anugr\\Desktop\\kannur.txt");
	...
	public kannur1() {
		...
		JLabel lblNewLabel = new JLabel("Hospital In Kannur");
