...
public class Ernakulam extends JFrame {
	...
	private void displayErnakulamdetails(Object [] row) {
		File file =new File("C:\\Users\\anugr\\Desktop\\ernakulam.txt");
	...
	public Ernakulam() {
		...
		JLabel lblNewLabel = new JLabel("Hospital In Ernakulam");
